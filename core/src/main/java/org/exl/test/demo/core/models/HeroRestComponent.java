package org.exl.test.demo.core.models;
...
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import org.exl.test.demo.core.javabeans.HeroTextBean;
...
public class HeroRestComponent extends WCMUsePojo
{
    ...
    public void activate() throws Exception {
        ...
        String employee_code = getProperties().get("firstName", "");
        
        String myJSON = getJSON(employee_code);
         
        //String myCountry=parse(myJSON);
             
       
        //Set Bean to store the values
        heroTextBean.setMyJSON_Response(myJSON);
        
        heroTextBean.setEmployee_code(employee_code);
  ...
  //Invokes a third party Restful Web Service and returns the results in a JSON String
    private String getJSON(String employee_code)
    {
        ...
        try
        {
            ...
            HttpGet getRequest = new HttpGet("http://dummy.restapiexample.com/api/v1/employee/"+employee_code);
